#!/usr/bin/env node
// Copies the proof skill into ./skills before npm pack/publish so users who
// install this sibling alone get the matching doctrine. The meta-package
// agent-booster-pack loads skills only from agent-booster-pack-skills, so the
// bundled copy here sits unused (no double-load) when the meta is installed.
