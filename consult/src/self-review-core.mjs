export const REMINDER = `Consult self-review — before declaring this turn done, run a final-pass self-review of your diff against Consult engineering maturity.
